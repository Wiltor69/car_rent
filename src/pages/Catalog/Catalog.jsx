...
export default function Catalog() {
  ...
  const handleFilter = () => {
    ...
    if (price !== '') {
      ...
      for (let car of array) {
        const choicePrice = car.rentalPrice.slice(1, car.rentalPrice.length);
  ...
  carsBrand = filterCars.filter((element, index, array) => index < page * 12);
  ...
  return (
    <>
      ...
      {carsBrand.length === 0 && !isLoading && (
        <Message>
          Unfortunately, there is no suitable car for your request. Try changing
          your search parametrs
        </Message>
      )}
